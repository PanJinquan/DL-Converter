...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_onnx_2eproto_metadata_getter(int index);
namespace onnx {
...
class AttributeProto PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_onnx_2eproto_metadata_getter(kIndexInFileMessages);
  }
